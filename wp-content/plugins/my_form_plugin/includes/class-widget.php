...
class VisualFormBuilder_Widget extends WP_Widget {
	...
	public function __construct(){
		...
		$this->field_table_name 	= $wpdb->prefix . 'my_form_plugin_fields';
		$this->form_table_name 		= $wpdb->prefix . 'my_form_plugin_forms';
		$this->entries_table_name 	= $wpdb->prefix . 'my_form_plugin_entries';

		parent::__construct(
			'vfb_widget',
			__( 'my_form_plugin', 'vfb-pro' ),
			array(
				'classname'   => 'vfb_widget_class',
				'description' => __( 'my_form_plugin', 'visual-form-builder' ),
			)
		);
	}
